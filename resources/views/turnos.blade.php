    ...
    <main>
     <div class="form-group">
      ...
      {{-- <!-- Grupo: Teléfono -->
            ...
            <span class="input-group-text bg-dark text-white" id="addon-wrapping">CODIGO </span>
            <input type="number" class="form-control formulario__input" name="codigoArea" id="codigoArea"  maxlength="4" placeholder="0343" aria-describedby="addon-wrapping" required>
            <i class="formulario__validacion-estado fas fa-times-circle"></i>
            &nbsp;<span class="input-group-text bg-dark text-white" id="addon-wrapping"> 15</span>
            <input type="number" class="form-control formulario__input" name="telefono" id="telefono"  maxlength="7" placeholder="4652xxx" aria-describedby="addon-wrapping" required>
            <i class="formulario__validacion-estado fas fa-times-circle"></i>
          </div>
        </div>
        <p class="text-info ">*Esta pregunta es obligatoria</p>
				<p class="formulario__input-error">El teléfono solo puede contener numeros y el maximo son 7 dígitos.</p>
  ...
  <div class = "col-md-4 col-6">
          <div class="formulario__grupo" id="grupo__codigoArea">
            <div class="formulario__grupo-input">
                ...
                <input type="number" class="form-control w-100 formulario__input" name="codigoArea" id="codigoArea"  maxlength="4" placeholder="0343" aria-describedby="addon-wrapping" required>
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
              </div> 
              <p class="formulario__input-error">El Código de Area solo puede contener numeros y el maximo son 4 dígitos.</p>
            </div>
    ...
    <p class="text-info ">*Esta pregunta es obligatoria</p> 
     ...
     <div class="modal fade" id="myModal" name="myModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop" aria-hidden="true">
           ...
           {{--  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
            ...
            <br>
            <div class="formulario__grupo formulario__btn-enviar">
            <button class="btn btn-dark btn-success"  type="reset" id="cancelar">Cancelar</button>
            <button class="btn  btn-dark btn-success"  type="submit">Aceptar</button>
               <!-- Menesaje de Exitoso -->
               <div class="formulario__mensaje-exito fs-5 m-2 p-2" id="formulario__mensaje-exito">
