            ...
            @foreach($ventas as $unaVenta)
                <tr>
                    ...
                    <td>
                            ...
                            <a href="{{ route('ventas.show', $unaVenta->id)}}" name="ver" class="btn btn" title="Ver"><i class="fa-solid fa-eye"></i></a>             
                  
                            <button class="btn btn eliminar" title="Eliminar"  id='{{$unaVenta->id}}' value= '{{$unaVenta->id}}'><i class="fa-solid fa-trash-can"></i></button>
