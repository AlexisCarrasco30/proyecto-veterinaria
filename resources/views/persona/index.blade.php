            ...
            @foreach($personas as $unaPersona)
                <tr>
                    ...
                    <td>
                            ...
                            <a href="{{ route('personas.show', $unaPersona->id)}}" name="ver" class="btn btn" title="Ver"><i class="fa-solid fa-eye"></i></a>
                            <a href="personas/{{$unaPersona->id}}/edit" name="Editar" class="btn btn " title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>
                        {{-- <a href="{{ route('verMascotas', $unaPersona->id)}}" name="mascota" class="btn btn-light"><i class="fa-solid fa-dog"></i></a> --}}
             
                  
                            <button class="btn btn eliminar" title="Eliminar"  id="{{$unaPersona->id}}" value= '{{$unaPersona->id}}'><i class="fa-solid fa-trash-can"></i></button>
